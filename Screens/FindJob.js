        ...
        .then(async (docRef) => {
          ...
          await db
            ...
            .then(() => {
              ...
              const path =
                auth.email + "/FindJobPostPicture/" + doc.id + ".jpg";
      ...
      <View style={styles.webContainer}>
        ...
        >
          ...
          <View style={styles.inputContainer}>
            ...
            ></View>
            <TextInput
              placeholder="အလုပ် လုပ်ကိုင်နိုင်သည့်မြို့"
              style={styles.input}
              onChangeText={(text) => {
                setworkplace(text);
              }}
          ...
          <View style={styles.inputContainer}>
            ...
            ></View>
            <TextInput
              placeholder="သင်၏ အစွမ်းအစ နှင့် သင့်ထံမှ ရနိုင်သည့် ဝန်ဆောင်မှုများကိုရေးနိုင်သည် "
              style={styles.input}
              multiline={true}
              onChangeText={(text) => {
                setads(text);
